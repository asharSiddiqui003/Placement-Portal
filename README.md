...
- Performance tracking across multiple test attempts
...
### Tables
- `user_profiles` - Student information and placement data
- `mock_tests` - Test templates with questions
- `test_attempts` - User test submissions and scores
- `question_bank` - Interview questions database
- `announcements` - Placement notifications
- `resumes` - Resume uploads with ATS scores
...
1. **Register**: Create an account with your details (name, roll number, branch, year, CPI)
2. **Explore Dashboard**: View your stats and upcoming opportunities
3. **Take Mock Tests**: Practice with company-specific and general aptitude tests
4. **Browse Questions**: Search and filter questions by company, topic, and difficulty
5. **Upload Resume**: Get instant ATS feedback and improvement suggestions
6. **Track Progress**: View analytics and performance trends
7. **Manage Profile**: Update information and track applications
...
- Client-side caching for bookmarks
...
- Design inspiration from modern placement portals
